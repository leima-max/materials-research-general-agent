...
Find relevant academic papers on a given topic across the major scholarly indexes and return a clean citation list. Search systematically, record source limits, and avoid implying access to subscription databases unless the user provides it.
