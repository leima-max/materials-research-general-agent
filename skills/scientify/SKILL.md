...
# Install Scientify Stack

**Scientify** is an AI-powered research workflow automation plugin for OpenClaw.

This skill is an external-tool setup guide. In a Codex-only project, do not claim
Scientify commands or tools are available unless OpenClaw and the Scientify plugin
are installed and discoverable in the user's environment.
